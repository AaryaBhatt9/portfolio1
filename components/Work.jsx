...
const Work = (isDarkMode) => {
 ...
 id='work' className='w-full px-[12%] py-10 scroll-mt-20' >
    ...
    Welcome to my projects explore them, range of the projects. I am a Software Developer from California, USA with 10 yrs of exp. 
    in working with companies such as Microsoft, Tesla, Apple. </motion.p>
    ...
    {workData.map((project,index)=>(
      ...
      transition={{duration:0.6, delay: 0.8}}
        ...
        text-gray-700 border-[0.5 px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover '>Show More
