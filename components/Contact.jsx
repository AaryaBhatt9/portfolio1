...
const [result, setResult] = useState("");
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "8b8926fa-dc4d-4722-aaa5-3814890d2fc0");
  ...
  return (
    ...
    rows ='8'  placeholder='Enter your message..' required  
    ...
    mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover' type='submit'>Submit  <Image src={assets.right_arrow_white} alt='' className='w-4'/> </motion.button>
